    ...
    <div className="footer__component py-3">
      <Container>
          ...
          <Row>
            ...
            <Col md={3}>
              <div className="p-2">
                ...
                <p>Email: support@buynsave.com.bd</p>
            ...
            <Col md={3}>
              <div className="social-icons float-md-end p-2">
                ...
                <a
                  ...
                  className="social_bg facebook-bg m-2"
                >
                  <FaFacebookF />
                </a>
                <a
                  href="https://iastagram.com"
                  className="social_bg instagram-bg m-2"
                >
                  <AiOutlineInstagram />
                </a>
                <a
                  href="https://youtube.com"
                  className="social_bg youtube-bg m-2"
                >
                  <AiOutlineYoutube />
                </a>
              </div>
        ...
        <p className="text-center pt-3">
          &copy; 2021 buynsave.com Limited. All rights reserved.
        </p>
      </Container>
    </div>
  );
